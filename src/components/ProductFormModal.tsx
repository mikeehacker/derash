        ...
        <form onSubmit={handleFormSubmit} className="flex flex-col flex-1 overflow-hidden bg-white">
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Right side inputs: Date & Optional Image Upload */}
              <div className="space-y-5">
                {/* Custom Datepicker */}
                ...
                <div>
                  ...
                  {imagePreview ? (
                    ...
                    <label className="flex flex-col items-center justify-center border-2 border-dashed border-zinc-250/70 rounded-[24px] p-6 sm:p-8 hover:bg-zinc-50/60 hover:border-[#009b3a]/50 bg-zinc-50/10 cursor-pointer transition-all duration-155 select-none text-center">
